...
#!/usr/bin/env python3
"""
Add more policy_bypass data from:
- harpreetsahota/red-team-prompts-questions (already used, but we'll add all)
- svannie678/red_team_repo_social_bias_prompts (new)
- Possibly more from moderation dataset (already included)
Then retrain Logistic Regression and Linear SVM, choose best.
"""
...
print("=" * 60)
print("Loading datasets (with extra policy_bypass sources)...")

# 1. Prompt injection datasets (as before)
...
# 2. Policy bypass datasets (boosted)
...
# 3. Benign datasets (same as before)
...
print("\n✅ Final Arjuna training completed. Restart server and test again.")
