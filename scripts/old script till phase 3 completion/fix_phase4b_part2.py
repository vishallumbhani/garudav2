...
# 1. Fix Yudhishthira to resolve tenant_id from tenant_key
    ...
    def run(self, request, bhishma_result, context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            with conn.cursor() as cur:
                # Get tenant UUID from tenant_key
...
print("✅ Yudhishthira fixed to resolve tenant_id from tenant_key.")

# 2. Add hanuman_info extraction to Krishna if missing
...
# 3. Ensure external_score is integer (already in place, but ensure)
